...
Error: The type t/349 introduced by this open appears in the signature
       Line 1, characters 46-47:
         The value x has no valid type if t/349 is hidden
|}];;
...
5 |       let x = T
6 |     end
Error: The type t/354 introduced by this open appears in the signature
       Line 7, characters 8-9:
         The value y has no valid type if t/354 is hidden
|}];;
...
4 |       type t = T
5 |     end
Error: The type t/359 introduced by this open appears in the signature
       Line 6, characters 8-9:
         The value y has no valid type if t/359 is hidden
|}]
